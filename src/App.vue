    ...
    <nav class="navbar is-dark">
      ...
      <div class="navbar-menu" id="navbar-menu" v-bind:class="{'is-active': showMobileMenu}">
        ...
        <div class="navbar-end">
          <router-link to="/electronicos" class="navbar-item">Electronicos</router-link>
          <router-link to="/computadoras" class="navbar-item">Computadoras</router-link>

          <div class="navbar-item">
            <div class="buttons">
              <template v-if="$store.state.isAuthenticated">
                <router-link to="/perfil" class="button is-light">Mi Perfil</router-link>
              </template>
              <template v-else>
  ...
  computed: {
    cartTotalLength(){
      ...
      for (let index = 0; index < this.cart.items.length; index++) {
        totalLength += this.cart.items[index].cantidad
      }
